...
export default function LuxuryServiceCard({ service, delay }: LuxuryServiceCardProps) {
  ...
  return (
    <motion.div
      ...
      className="border-2 border-[var(--accent)]/30 bg-gradient-to-br from-black/40 to-black/20 p-8 md:p-12 space-y-6 transition-all duration-700 hover:shadow-[0_0_40px_rgba(247, 168, 53,0.5)] cursor-default"
    >
