...
export function GlowCard({
  ...
  const variantStyles = {
    ...
    accent:
      "border-2 border-[var(--accent)]/50 bg-gradient-to-br from-[var(--accent)]/10 to-[var(--accent)]/5 backdrop-blur-sm hover:shadow-[0_0_40px_rgba(247, 168, 53,0.5)] duration-700",
  };
