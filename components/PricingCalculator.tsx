...
export default function PricingCalculator() {
  ...
  return (
    <div className="bg-[#0A0A0A] border border-[#E0E0E0]/30 p-6 space-y-6">
      <h4 className="text-[18px] md:text-[22px] font-bold text-[var(--accent)] uppercase">
        Project Estimator
      </h4>
      ...
      <div>
        <label className="block text-[14px] text-[#E0E0E0]/70 mb-2">
          Project Duration: <span className="text-[var(--accent)] font-bold">{weeks} weeks</span>
        </label>
        <input
          type="range"
          min="2"
          ...
          className="w-full h-2 bg-[#E0E0E0]/20 appearance-none cursor-pointer accent-[var(--accent)]"
        />
      </div>
      ...
      >
        <div className="flex justify-between items-baseline">
          ...
          <span className="text-[28px] md:text-[36px] font-bold text-[var(--accent)] tabular-nums">
